...
const Sitemap = () => {
  ...
  const pages = [
    ...
    { name: "For Dentists - Implants", path: "/for-dentists/implants" },
    { name: "For Dentists - Sedation", path: "/for-dentists/sedation" },
    { name: "For Dentists - Endodontics", path: "/for-dentists/endodontics" },
    { name: "For Dentists - Molar Support", path: "/for-dentists/mos" },
