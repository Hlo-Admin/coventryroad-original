            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                  Endodontic Treatment at Coventry Road Dental Care –{" "}
                  <span className="text-[#63316b]">Why Choose Us?</span>
                </h2>
                <div className="prose prose-lg text-gray-700 space-y-4">
                  <p>
                    Endodontic treatments can be complex and very time-consuming
                    which in turn creates some difficulty for NHS dentists to
                    fit this treatment into their already extremely busy
                    diaries, which is why we have a dentist here at Coventry
                    Road Dental Care with a special interest in endodontics who
                    is dedicated to these types of cases.
                  </p>
                  <p>
                    Many endodontic cases may require advanced equipment to
                    complete to a satisfactory standard. We have all the latest
                    endodontic equipment and materials. Our fees are competitive
                    and reflect case complexity. We offer a professional but
                    also relaxed and friendly environment to patients.
                  </p>
                </div>
                <div className="mt-8">
                  <button
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-8 md:p-12">
              ...
              <div className="prose prose-lg text-gray-700 space-y-4">
                <p>
                  I have an interest in Endodontics. I have finished my PG
                  diploma in Endodontics with distinction. I qualified in 2003
                  (India) and have been doing general practice.
                </p>
                <p>
                  I finished IQE in 2007 and have been fully registered with GDC
                  since 2007. I work in mixed practice in Bedworth,
                  Warwickshire, which is a foundation practice and British
                  Dental Association (BDA) good practice.
                </p>
                <p>
                  I have done Membership of Joint Dental Faculty (MJDF) with
                  Royal College in 2014 and finished my PG Diploma in
                  Endodontics from Kings College with distinction. I have been
                  providing endodontic treatments since.
                </p>
                <p>
                  I am a tier 2 accredited dentist and have been providing
                  treatments as part of United Kingdom Dental hospital from the
                  start of 2022. I am also a member of the British Endodontic
                  Society (BES) and Dental Trauma UK.
                </p>
                <p>
                  Outside of work, I enjoy my time with my family, married with
                  two kids. I enjoy nature photography, travelling, watching
